...
<body>
<div class="wrap">
  <h1>Welcome to ETAXPLANNER</h1>
  <p>Thank you for subscribing to the ETAXPLANNER newsletter. We are excited to keep you informed about premium Dubai real estate property launches, exclusive off-market listings, and GCC market insights.</p>
  <p>You will be the first to receive updates on high-yield developments and direct developer pricing, with zero buyer brokerage fees.</p>
  <a class="btn" href="{{ config('app.url') }}/investments">Explore Properties</a>
